...
- Already completed wagering takes priority over expiration, including historical Stage 5 progress. A completing round settles its win and advances progress before converting the remaining bonus; terminal statuses cannot change. Expiration resolved before a business rejection commits, while technical failures roll back the whole operation.
